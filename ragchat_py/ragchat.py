...
from constants import DEFAULT_CHAT_RATELIMIT_SESSION_ID, DEFAULT_CHAT_SESSION_ID, DEFAULT_HISTORY_LENGTH, DEFAULT_HISTORY_TTL, DEFAULT_NAMESPACE, DEFAULT_SIMILARITY_THRESHOLD, DEFAULT_TOP_K, default_prompt_without_rag
from contextservice.index import ContextService
from database import Database


class ChatOptions:
    streaming: Optional[bool] = None
    onChunk: Optional[Callable[[Dict[str, Any]], None]] = None
    sessionId: Optional[str] = None

class ModifiedChatOptions(ChatOptions):
    pass
